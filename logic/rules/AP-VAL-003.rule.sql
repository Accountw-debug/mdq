...
plain_logic: >
  ...
  Euro-Wirkung: die offenen Posten des Kreditors sind der Betrag, der beim nächsten
  Zahllauf über genau diese Bankverbindung hinausginge. Er kommt aus
...
SELECT
    ...
    -- Euro-Wirkung: was beim naechsten Zahllauf ueber diese Bankverbindung hinausginge.
    ...
    CASE WHEN r.open_items_local > 0
         THEN 'Offene Posten ' || mdq_money(r.open_items_local, r.currency)
              || ', die an diese IBAN gezahlt würden'
