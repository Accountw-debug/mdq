...
| AR-CON-002 | Löschvormerkung/Sperre bei offenen Posten | consistency | high | 3 | decision | decision | business_partner, bp_company_code, company_code, fi_item | XD05/XD06 | impl | Defekt |
...
| AP-COM-003 | Prüfung doppelte Rechnung (REPRF) nicht gesetzt | completeness | high | 3 | A | mass_change | business_partner, bp_company_code | XK02 Zahlungsverkehr | impl | Defekt |
...
| AP-CON-001 | Gleiche IBAN bei mehreren Kreditoren | consistency | critical | 1 | C | review | business_partner, bp_bank_account, bp_company_code, bp_partner_function, bp_relevance | XK02 | impl | Defekt |
