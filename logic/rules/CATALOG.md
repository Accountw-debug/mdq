...
| AR-COM-002 | Zahlungsbedingung im Buchungskreis leer | completeness | medium | 2 | B (Soll = meistgenutzte ZTERM aus Belegen) | review | bp_company_code, fi_item, payment_terms | XD02 Zahlungsverkehr | draft | Defekt |
...
| AR-VAL-003 | IBAN-Prüfziffer ungültig | validity | critical | 1 | C | review | bp_bank_account | XD02 | draft | Defekt |
...
| AR-HYG-001 | Kein Posten im gesamten Postenfenster, Anlage vor Fensterbeginn, keine OP (Löschkandidat) | hygiene | low | 3 | decision (Policy kann zur Laufzeit auf A heben) | decision | business_partner, bp_relevance | XD06 | draft | Defekt |
